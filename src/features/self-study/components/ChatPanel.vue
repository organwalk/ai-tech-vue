  ...
  <div class="chat-panel">
    ...
    <div class="chat-input-area">
      <textarea
        ...
        class="chat-input"
        :placeholder="isDisabled ? '请先选择文件' : '输入消息，按 Enter 发送，Shift+Enter 换行'"
...
const isDisabled = computed(() => !props.selectedFileIds || props.selectedFileIds.length === 0)
...
const getCacheKey = (page) => `${props.windowId}-${page}`
